...
- [vue多环境配置(以测试环境为例)](#vue多环境配置以测试环境为例)
    - [多页条件下添加除生产（build）与开发（dev）环境外的测试环境](#多页条件下添加除生产build与开发dev环境外的测试环境)
        - [package.json 修改如下](#packagejson-修改如下)
        - [webpack修改](#webpack修改)
    - [单页多环境配置](#单页多环境配置)
...
* 修改index.js
  ...
  ```
## 单页多环境配置
> 单页与多页配置大致相同，需要注意的地方在于多页的多入口与多出口